...
<head>
    ...
    <title> @yield('title') | system informasi - e-cafe</title>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ $basedir }}">e-cafe system</a>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ $basedir }}/user/tambah">
                                    <span>Tambah</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ $basedir }}/user/list">
                                    <span>list</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <a href="javascript:void(0);" class="menu-toggle">
                                ...
                                <ul class="ml-menu">
                                    <li class="header" style="text-align: center;">Bahan</li>
                                    <li>
                                        <a href="{{ $basedir }}/bahan/tambah">
                                            <span>Tambah Bahan</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ $basedir }}/stock/tambah">
                                            <span>Tambah Stock</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ $basedir }}/bahan/list">
                                            <span>List</span>
                                        </a>
                                    </li>
                                    <!--
                                    <li class="header" style="text-align: center;">Stock Bahan</li>
                                    <li>
                                        <a href="{{ $basedir }}/stock/tambah">
                                            <span>Tambah Stock</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="{{$basedir}}/stock/list">
                                            <span>List Stock</span>
                                        </a>
                                    </li>
                                    -->
                                    <li class="header" style="text-align: center;">Item</li>
                                    <li>
                                        <a href="{{$basedir}}/item/tambah">
                                            <span>Tambah Item</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{$basedir}}/item/list">
                                            <span>List Item</span>
                                        </a>
                                    </li>
                                </ul>
